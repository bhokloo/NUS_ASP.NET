...
namespace FirstMVC.Controllers
{
   ...
   //______________________________RAZOR VIEW_________________________________________________________
        ...
        public ActionResult ServerSideValidation(string s)
        {
            Debug.WriteLine("HttpGet Server");
            return View();
        }
        ...
        [HttpPost]
        public ActionResult ServerSideValidation(ServerValidation sv)
        {
            Dictionary<string, string> errDict = new Dictionary<string, string>();
            if (Request["username"] == "")
            {
                errDict.Add("username", "Username cannot be null");
        ...
        [AuthenticationFilter] //Filtering and not URL Routing
        public ActionResult Contact1(string id)
        {
